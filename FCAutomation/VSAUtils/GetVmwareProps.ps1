...
write-host "GUID="$var1";PowerState="$var2";GuestOS="$var3";Memory="$var9";NoofCPU="$var5";Diskcount="$var6";IP="$var7";NIC="$var8";ESXHost="$var4";Datastore="$var10";ResourcePool="$var11";DataCenter="$var12";Hostname="$var13";ToolsStatus="$var14";snapExists="$var15";VMSpace="$var16";NetworkName="$var17
}
...
write-host "GUID="$var1";PowerState="$var2";GuestOS="$var3";IP="$var4
}
else
{
...
{
 $network_name = (Get-NetworkAdapter -VM ($global:vmName)).NetworkName
 return $network_name
}