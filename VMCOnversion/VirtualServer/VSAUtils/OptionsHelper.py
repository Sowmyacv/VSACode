...
class FileLevelRestoreOptions(object):
    ...
    def browse_from_snap(self, value):
        ...
        self.copy_precedence = self.auto_subclient.auto_commcell.find_snap_copy_id(
    ...
    def browse_from_backup_copy(self, value):
        ...
        """
        self.copy_precedence_applicable = value
        self.copy_precedence = self.auto_subclient.auto_commcell.find_primary_copy_id(
            self.auto_subclient.sp_id)
    ...
    def browse_from_aux_copy(self, value):
        ...
        """
        self.copy_precedence_applicable = value
        self.copy_precedence = self.auto_subclient.auto_commcell.find_aux_copy_id(
            self.auto_subclient.sp_id)
    ...
    def populate_hypervisor_restore_inputs(self):
        ...
        try:
            ...
            def vmware():
                ...
                #self._dest_client_name = machine.Machine(self._dest_client_name,
                #                                         self.auto_subclient.auto_commcell.commcell)
